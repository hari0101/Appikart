    ...
    return Container(
      ...
      child: ListView(
        ...
        children: <Widget>[
          ...
          /*Category(
            image_location: 'assets/images/cats/wallets.png',
            image_caption: 'wallet',
          ),
          Category(
            image_location: 'assets/images/cats/watch.png',
            image_caption: 'Watch',
          ),
          Category(
            image_location: 'assets/images/cats/footwear.png',
